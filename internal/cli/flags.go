...
func ParseFlags() *Flags {
	...
	flag.BoolVar(&flags.CacheBackup, "cache-backup", false, "Back up current cache to cache.bak/")
	flag.BoolVar(&flags.CacheRestore, "cache-restore", false, "Restore cache from cache.bak/ backup")
