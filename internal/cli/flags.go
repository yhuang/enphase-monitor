...
func ParseFlags() *Flags {
	...
	flag.BoolVar(&flags.UpdateRefreshTokens, "update-refresh-tokens", false, "Run the OAuth wizard to obtain a refresh token and save it into credentials.yaml. Pass the credential name as an argument when more than one is configured: --update-refresh-tokens <name>")
